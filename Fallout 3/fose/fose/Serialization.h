...
struct PluginCallbacks
{
	...
	FOSESerializationInterface::EventCallback	preLoad;
...
void	HandleLoadGame(const char * path, FOSESerializationInterface::EventCallback PluginCallbacks::* callback = &PluginCallbacks::load);
